...
int Inventory::drop(string itemName)
{
    ...
    {
        cout << "You do not own that weapon" << endl;
        worth = 0;
    }
    return worth;
}
...
void Inventory::setPotionHealing(int healing)
{
    P.setHealing(healing);   //set healing value
}

void Inventory::setPotionCost(int cost)
{
    P.setCost(cost);
}

int Inventory::getPotionHealing()
{
    return P.getHealing();   //return healing value
}

int Inventory::getPotionCost()
{
    return P.getCost();
}
